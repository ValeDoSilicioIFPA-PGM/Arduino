...
const char* ssid = "Arduino"; // Nome da Rede

const char* password = "arduinoboy"; //Password da rede

 

int led1 = 13; // GPIO13 do ESP8266 e D7 do NodeMCU
int led2 = 2;
//int ledVerde = 7;
...
pinMode(led1, OUTPUT); // Define o D7 como saída

digitalWrite(led1, LOW); // O LED começa desligado
pinMode(led2, OUTPUT);
...
digitalWrite(led1, HIGH); // Se o pedido no LedPin for LED=ON, acende o LED
...
digitalWrite(led1, LOW); // Se o pedido no LedPin for LED=OFF, apaga o LED
...
digitalWrite(led2, HIGH); // Se o pedido no LedPin1 for LED=ON, acende o LED
...
digitalWrite(led2, LOW); // Se o pedido no LedPin1 for LED=OFF, apaga o LED
